...
public class FolhaPagamento {
  public static void main(String[] args) {
    ...
    for (int i = 0; i < registros.length; i++) {
      int tipo = showOptionDialog(null,"Tipo do funcionário",
        "Selecione",0,QUESTION_MESSAGE,null,
        new String[]{"Padrão","Comissionado","Produtividade"},
        "Padrão");
      if(tipo == -1) break;
      ...
      while (true) {
        str = showInputDialog(null,"Informe a matrícula");
        if (str == null) break;
        try {
      ...
      while (true) {
        str = showInputDialog(null,"Informe o salário");
        if (str == null) break;
        try {
      ...
      if (registros[i] instanceof FComissionado) {
        while (true) {
          str = showInputDialog(null,"Informe o % da comissão");
          if (str == null) break;
          try {
      ...
      if (registros[i] instanceof FProdutividade) {
        ...
        while (true) {
          str = showInputDialog(null,"Nº de unidades produzidas");
          if (str == null) break;
          try {
